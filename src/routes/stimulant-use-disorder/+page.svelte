<script>
  ...
  import pageData from '$lib/content/conditions/stimulant-use-disorder.json';
...
<div class="page">
  ...
  <section class="cta">
    <div class="container">
      <h2>Ready to Talk?</h2>
      <p>Our clinicians specialize in {pageData.condition.name.toLowerCase()} and co-occurring conditions. Getting started takes one conversation.</p>
...
<style lang="scss">
  ...
  .hero {
    ...
    .intro { font-size: 1.15rem; max-width: 720px; line-height: 1.7; }
  }
  .criteria {
    background-color: #f8f8f8;
    .criteria-list { margin: var(--space-tiny) 0; padding-left: 1.5rem; li { margin-bottom: 0.75rem; line-height: 1.6; } }
    .criteria-note { font-style: italic; color: #666; font-size: 0.925rem; }
  }
  .how-it-feels {
  ...
  .treatment {
    background-color: #f8f8f8;
    .treatments-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(260px,1fr)); gap: var(--space-small); margin-top: var(--space-small); }
    .treatment-card { background: white; padding: var(--space-tiny); border-radius: 6px; border: 1px solid #e0e0e0; h3 { margin-bottom: 0.5rem; font-size: 1.1rem; } p { font-size: 0.95rem; line-height: 1.6; margin: 0; } }
  }
  .cta {
    background-color: var(--c-green); color: white; text-align: center;
    ...
    .contact-info { font-size: 1.1rem; a { color: white; box-shadow: 0 1px 0 0 white; } }
  }
  @media (min-width: 768px) { .cta .cta-actions { flex-direction: row; justify-content: center; } }
</style>
